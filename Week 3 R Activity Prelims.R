...
head(Amanda_mydata, 2)

#This code chunk shows me the structure 
#Such as number of columns, number of observations, names of the columns, and class of each columns followed by few of the initial observations of each column
...
#Such as Min, Mean, Median, Max, and Quartiles
#Task: Complete the comment above
summary(Amanda_mydata)
...
#The run of "NewWomen" has duplicated each column for height and weight, because it includes "HeightandWeight" which we previously set to be height and weight. The 2nd code shows 2 columns, this now has 4 total.
